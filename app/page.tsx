...
export default function Portfolio() {
  ...
  description: "AI-powered web application that analyzes job descriptions and optimizes resumes to improve ATS compatibility and increase interview potential",
  icon: (
    <svg
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M9 12h6m-6 4h6M8 7h8M7 4h10a2 2 0 012 2v12a2 2 0 01-2 2H7a2 2 0 01-2-2V6a2 2 0 012-2z"
      />
    </svg>
  ),
  githubLink: "https://github.com/Chanakya-Das-Sahu/groq-resume",
  visitLink: "https://get-optimized-resume.netlify.app/"
},
    {
    ...
    },
    {
      ...
      description: "An AI-powered web app that provides transcripts from YouTube video URLs and generates MCQs with a participation feature",
      icon: (
        <svg className="w-12 h-12 text-[#0000CD]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
